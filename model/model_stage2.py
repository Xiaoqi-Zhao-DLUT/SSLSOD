...
class Contour_Estimation(nn.Module):

    def __init__(self):
        super(Contour_Estimation, self).__init__()
    ...
    def forward(self,  e5_rgb,e4_rgb,e3_rgb,e2_rgb,e1_rgb, e5_depth,e4_depth,e3_depth,e2_depth,e1_depth):
